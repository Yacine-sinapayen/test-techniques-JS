...
La fonction doit renvoyer la valeur moyenne du tableau table donné en paramètre. 'table' est toujours un tableau défini, et ne contient que des nombres. La fonction average doit retourner 0 si table est vide. */
...
Pour cela faire une moyenne (somme de tous les élements du tableau que je divise pa la taille de celui-ci). 
    1 - je crais une let 'sum' dans laquelle je vais aditionner tout les élems de mon tableau' que j'instencie à 0. 
