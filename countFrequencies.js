...
/* Implémention : créer une fonction countFrequencies(words)
qui retourne un tableau d'entiers contenant le nombre d'occurrences de chaque mot triés par ordre alphabétique.
    ...
    3 - je boucle sur la taille de mon tableau
        3.a - Si le mot en cours d'ittération existe dans mon tableau alors je rajourte une occorence au mot dans mon tableau
